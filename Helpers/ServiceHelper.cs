...
/// <summary>
/// Acceso al contenedor de dependencias desde las paginas, que MAUI no inyecta
/// automaticamente al navegar (constitucion 4: inyeccion de dependencias para todos los servicios).
/// </summary>
