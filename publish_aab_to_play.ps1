...
Write-Host '========================================'
Write-Host ' File Manager - Publish AAB to Play Console'
Write-Host '========================================'
Write-Host
...
$defaultReleaseName = if ($defaultDisplayVersion -and $defaultVersionCode) {
    "File Manager $defaultDisplayVersion ($defaultVersionCode)"
}
elseif ($defaultVersionCode) {
    "File Manager ($defaultVersionCode)"
}
else {
    "File Manager $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
}
